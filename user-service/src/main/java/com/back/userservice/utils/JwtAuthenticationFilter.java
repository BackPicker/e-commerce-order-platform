...
import com.back.userservice.dto.TokenResponse;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        UserRoleEnum role = ((UserDetailsImpl) authResult.getPrincipal()).getUser()
                .getRole();
        Long userId = ((UserDetailsImpl) authResult.getPrincipal()).getUser()
                .getId();
        String secChUaPlatform = request.getHeader("Sec-Ch-Ua-Platform");
        String passwordVersion = ((UserDetailsImpl) authResult.getPrincipal()).getUser()
                .getPasswordVersion();
