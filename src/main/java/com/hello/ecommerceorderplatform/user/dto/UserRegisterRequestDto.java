...
public class UserRegisterRequestDto {
    ...
    private Address address; // Address 객체로 변경
    ...
    public UserRegisterRequestDto(String username, String password, String phoneNumber, String email, Address address, boolean admin, String adminToken) {
