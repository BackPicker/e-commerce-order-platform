package com.back.gatewayservice.filter;
...
public class JwtFilter extends AbstractGatewayFilterFactory<JwtFilter.Config> {
    ...
    public GatewayFilter apply(Config config) {
        return (exchange, chain) -> {
            ...
            try {
                Claims claims = Jwts.parserBuilder() // .setSigningKey(jwtSecret) -> .setSigningKey(key)
                        .setSigningKey(key)  // Use the decoded key (already done in init method)
                        .build()
